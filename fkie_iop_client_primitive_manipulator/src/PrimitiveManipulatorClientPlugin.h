...
#ifndef PRIMITIVEMANIPULATORCLIENTPLUGIN_H
#define PRIMITIVEMANIPULATORCLIENTPLUGIN_H

#include "urn_jaus_jss_manipulator_PrimitiveManipulatorClient/PrimitiveManipulatorClientService.h"
...
class DllExport PrimitiveManipulatorClientPlugin : public PluginInterface
{
public:
	PrimitiveManipulatorClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_manipulator_PrimitiveManipulatorClient::PrimitiveManipulatorClientService *p_my_service;
