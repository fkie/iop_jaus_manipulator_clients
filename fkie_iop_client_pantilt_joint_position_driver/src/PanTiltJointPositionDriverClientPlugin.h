...
#ifndef PANTILTJOINTPOSITIONDRIVERCLIENTPLUGIN_H
#define PANTILTJOINTPOSITIONDRIVERCLIENTPLUGIN_H

#include "urn_jaus_jss_manipulator_PanTiltJointPositionDriverClient/PanTiltJointPositionDriverClientService.h"
...
class DllExport PanTiltJointPositionDriverClientPlugin : public PluginInterface
{
public:
	PanTiltJointPositionDriverClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_manipulator_PanTiltJointPositionDriverClient::PanTiltJointPositionDriverClientService *p_my_service;
