...
#ifndef MANIPULATORSPECIFICATIONSERVICECLIENTPLUGIN_H
#define MANIPULATORSPECIFICATIONSERVICECLIENTPLUGIN_H
...
class DllExport ManipulatorSpecificationServiceClientPlugin : public PluginInterface
{
public:
	ManipulatorSpecificationServiceClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_manipulator_ManipulatorSpecificationServiceClient::ManipulatorSpecificationServiceClientService *p_my_service;
