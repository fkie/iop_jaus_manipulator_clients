...
#ifndef PANTILTSPECIFICATIONSERVICECLIENTPLUGIN_H
#define PANTILTSPECIFICATIONSERVICECLIENTPLUGIN_H
...
class DllExport PanTiltSpecificationServiceClientPlugin : public PluginInterface
{
public:
	PanTiltSpecificationServiceClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_manipulator_PanTiltSpecificationServiceClient::PanTiltSpecificationServiceClientService *p_my_service;
