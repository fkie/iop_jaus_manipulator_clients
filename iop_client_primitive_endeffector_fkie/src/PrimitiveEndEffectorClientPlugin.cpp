...
#include "PrimitiveEndEffectorClientPlugin.h"

using namespace iop;
using namespace urn_jaus_jss_manipulator_PrimitiveEndEffectorClient;
...
PrimitiveEndEffectorClientPlugin::PrimitiveEndEffectorClientPlugin()
{
	p_my_service = NULL;
	p_base_service = NULL;
...
JTS::Service* PrimitiveEndEffectorClientPlugin::get_service()
{
	return p_my_service;
}

void PrimitiveEndEffectorClientPlugin::create_service(JTS::JausRouter* jaus_router)
{
	...
	p_my_service = new PrimitiveEndEffectorClientService(jaus_router, p_transport_service, p_events_service, p_accesscontrol_service, p_base_service);
}

PLUGINLIB_EXPORT_CLASS(iop::PrimitiveEndEffectorClientPlugin, iop::PluginInterface)
