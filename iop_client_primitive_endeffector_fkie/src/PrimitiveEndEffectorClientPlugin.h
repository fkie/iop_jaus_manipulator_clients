...
#ifndef PRIMITIVAENDEFFECTORCLIENTPLUGIN_H
#define PRIMITIVAENDEFFECTORCLIENTPLUGIN_H

#include "urn_jaus_jss_manipulator_PrimitiveEndEffectorClient/PrimitiveEndEffectorClientService.h"
...
class DllExport PrimitiveEndEffectorClientPlugin : public PluginInterface
{
public:
	PrimitiveEndEffectorClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_manipulator_PrimitiveEndEffectorClient::PrimitiveEndEffectorClientService *p_my_service;
