...
#ifndef PRIMITIVEPANTILTCLIENTPLUGIN_H
#define PRIMITIVEPANTILTCLIENTPLUGIN_H

#include "urn_jaus_jss_manipulator_PrimitivePanTiltClient/PrimitivePanTiltClientService.h"
...
class DllExport PrimitivePanTiltClientPlugin : public PluginInterface
{
public:
	PrimitivePanTiltClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_manipulator_PrimitivePanTiltClient::PrimitivePanTiltClientService *p_my_service;
